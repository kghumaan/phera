  ...
  return (
    ...
    >
      <div className="container" style={{ position: 'relative', zIndex: 2 }}>
        {/* Header — left-aligned at the top of the section, mirroring
            FeatureStepper's "The full kit" header. Sits above the
            photo+copy grid so the heading is no longer pinned inside the
            right column. */}
        <SectionHeader
          eyebrow="origin"
        ...
        <Reveal>
          <div style={{ maxWidth: 480, marginInline: 'auto' }}>
            ...
            {/* Founder names + socials, sitting under the photo. Extra
                top margin clears the absolute-positioned date pill. */}
            <div
              style={{
                display: 'grid',
        ...
        {/* RIGHT: copy (heading + eyebrow now live in SectionHeader above) */}
        <Reveal delay={1}>
          <div>
            <div style={{ width: 64, height: 4, background: 'var(--accent)', borderRadius: 2, marginBottom: 28 }} />
            <div style={{ fontSize: 18, lineHeight: 1.7, maxWidth: '60ch' }}>
