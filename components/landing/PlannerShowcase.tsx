        ...
        <Reveal delay={3}>
          <div
            ...
            style={{
              ...
              display: 'grid',
              gridTemplateColumns: 'minmax(300px, 0.85fr) 1.15fr',
          ...
          >
            ...
            >
              ...
              >
                ...
                <AttachFileRoundedIcon sx={{ fontSize: 18, color: COLORS.text.subtle, flex: 'none' }} />
                <MicRoundedIcon sx={{ fontSize: 18, color: COLORS.text.subtle, flex: 'none' }} />
                <Box
                  sx={{
                    width: 32,
                    height: 32,
    ...
    case 'working':
      return (
        <Stack direction="row" spacing={1} alignItems="center">
          ...
          <Typography
            sx={{ fontFamily: FONTS.body, fontSize: '0.875rem', color: COLORS.text.subtle }}
          >
            {item.text}
          </Typography>
        </Stack>
      ...
      return (
        <Stack direction="row" alignItems="center" spacing={0.75}>
          ...
          {item.undo && (
            <Typography
              component="span"
              sx={{ fontFamily: FONTS.body, fontSize: '0.875rem', color: COLORS.brand.primary }}
            >
              Undo
            </Typography>
          )}
        ...
        >
          <Stack direction="row" spacing={1.25} alignItems="center" sx={{ mb: 1 }}>
            ...
            <Box sx={{ minWidth: 0 }}>
              <Typography
                noWrap
                sx={{ fontFamily: FONTS.body, fontSize: '0.875rem', fontWeight: 600, color: COLORS.text.strong }}
              >
                {item.fileName}
              </Typography>
              <Typography sx={{ fontFamily: FONTS.body, fontSize: '0.875rem', color: COLORS.text.subtle, lineHeight: 1.2 }}>
                {item.fileSize}
              </Typography>
            </Box>
          </Stack>
        ...
        >
          <Stack direction="row" spacing={1.5} alignItems="center">
            ...
            <Box sx={{ minWidth: 0, flex: 1 }}>
              <Typography
                noWrap
                sx={{ fontFamily: FONTS.body, fontSize: '0.875rem', fontWeight: 700, color: COLORS.text.strong }}
              >
                {item.name}
              </Typography>
              <Typography
                noWrap
                sx={{ fontFamily: FONTS.body, fontSize: '0.875rem', color: COLORS.text.muted, lineHeight: 1.3 }}
              >
          ...
          <Stack direction="row" alignItems="center" spacing={1} sx={{ mt: 1.25, flexWrap: 'wrap', rowGap: 0.5 }}>
            <Stack direction="row" alignItems="center" spacing={0.25}>
              ...
              <Typography sx={{ fontFamily: FONTS.body, fontSize: '0.875rem', fontWeight: 600, color: COLORS.text.strong }}>
                {item.rating}
              </Typography>
              <Typography sx={{ fontFamily: FONTS.body, fontSize: '0.875rem', color: COLORS.text.subtle }}>
                ({item.reviews})
              </Typography>
            </Stack>
            <Typography sx={{ fontFamily: FONTS.body, fontSize: '0.875rem', color: COLORS.text.muted }}>
              {item.price}
            </Typography>
    ...
    case 'confirm':
      return (
        ...
        >
          ...
          <Typography
            sx={{ fontFamily: FONTS.body, fontSize: '0.875rem', color: COLORS.text.subtle, mb: 1.25 }}
          >
            Why: {item.reason}
          </Typography>
