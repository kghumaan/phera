...
There's a new item in your Phera sidebar, right under Overview. It's called **Planner**, and it's a chat box.
...
Here's the first conversation most couples have with it, about ninety seconds after signing up:

<ChatDemo id="onboarding" />
...
You don't need to prepare anything. You don't need your guest list ready or your venue booked. The Planner is the first thing you see after you sign up, and it opens with four suggestions:
...
Pick one. Or just tell it, in your own words, what's actually stressing you out tonight.

<BlogCTA
  title="Your wedding has 300 guests and 4 days. You have a phone and 8% battery."
  body="The Planner is free, it's the first thing you see when you sign up, and it starts working from your first sentence."
  label="Talk to the Planner"
  href="/auth/login"
  secondaryHref="/demo"
  secondaryLabel="See a live demo wedding"
/>
