...
Notice the shape of that. Reading is instant and free — the Planner never asks permission to look. But *moving people between rooms* is a different class of action, so it stops, describes the move in plain English — who, from where, to where, who else is affected — and waits for you to tap **Confirm**.

<Callout tone="tip" title="Every move is reversible">
Before any reshuffle happens, the previous assignment is snapshotted, and an **Undo** button sits right there in the chat. Confirmed something at midnight that looks wrong at breakfast? One tap puts it back. You're never one sleepy decision away from re-doing the block.
</Callout>
...
The Planner itself is free — schedule, guests, RSVPs, website. Room assignments are part of the paid plan, alongside [transportation](/blog/destination-wedding-shuttle-logistics) and guest WhatsApp. If you ask for a room move on the free plan, it won't pretend the feature doesn't exist — it shows you what it would have done and what unlocking it costs.
</Callout>
