...
const painPoints = [
  {
    ...
    description:
      'Managing hundreds of guests across multiple events with different venues and timings.',
    icon: <SentimentDissatisfied color="error" fontSize="large" />,
  },
  {
    title: 'RSVP Chaos',
    description:
      'Tracking attendance through texts, emails, and calls. Plus-ones? Dietary restrictions? Good luck.',
    icon: <Warning color="error" fontSize="large" />,
  },
  {
    title: 'Travel & Accommodation Hell',
    description:
      'Coordinating airport pickups, managing room blocks, and answering "what\'s the hotel code?" 47 times.',
    icon: <Flight color="error" fontSize="large" />,
  },
  {
    title: 'The WhatsApp Spiral',
    description:
      'Five different wedding group chats, lost messages, and crucial info buried under forwarded videos.',
...
const keyFeatures = [
  {
    ...
    description:
      'Beautiful digital invites, multi-event tracking, plus-one management, and real-time dashboard.',
  ...
  },
  {
    ...
    description:
      'Broadcast updates instantly. Create organized event groups. No more lost messages.',
  ...
  },
  {
    ...
    description:
      'Centralized hotel info, room blocks, and airport pickup coordination.',
    icon: <Flight fontSize="large" sx={{ color: '#DE3F5E' }} />,
    badge: 'ADD-ON',
  },
  {
    title: 'Multi-Event Scheduler',
    description:
      'Detailed schedules, venue maps, dress codes, and timezone conversions.',
  ...
  },
  {
    ...
    description:
      'Organize by side (bride/groom), track special needs, and manage VIPs.',
    icon: <People fontSize="large" sx={{ color: '#DE3F5E' }} />,
    badge: 'ADD-ON',
  },
  {
    title: 'Custom Event Pages',
    description:
      'Share your love story, galleries, registry info, and cultural traditions.',
...
const weddingAgents = [
  {
    ...
    keyPoints: [
      'Collects flight & hotel details',
      'Groups guests by arrival time',
      'Coordinates shuttles & pickups',
    ],
    pricing: 49,
    badge: 'COMING SOON',
  ...
  },
  {
    ...
    problem: 'Guests missing events because they didn\'t get the message on time?',
    solution: 'Rohan sends WhatsApp broadcasts, keeps everyone updated, and ensures no one misses a moment.',
    keyPoints: [
      'WhatsApp event broadcasts',
  ...
  },
  {
    ...
    problem: 'Overwhelmed by dietary restrictions and endless menu options from your venue?',
    solution: 'Anjali analyzes allergies, suggests menus that work for everyone, and finds alternatives for strict diets.',
    keyPoints: [
      'Analyzes dietary restrictions',
      'Suggests balanced menus',
      'Finds local alternatives',
    ],
    pricing: 59,
    badge: 'COMING SOON',
  ...
  },
  {
    ...
    problem: 'Too many song requests and no idea how to create the perfect playlist?',
    solution: 'Karan curates playlists by event, balances cultural music styles, and creates the perfect vibe.',
    keyPoints: [
      'Curates event playlists',
      'Balances cultural styles',
  ...
  },
  {
    ...
    problem: 'Answering the same questions 50 times? "What\'s the dress code?" "Where should I eat?"',
    solution: 'Priya answers guest questions via WhatsApp/SMS, provides local recommendations, and explains traditions.',
    keyPoints: [
  ...
  },
  {
    ...
    problem: 'Juggling vendor contracts, payments, and day-of coordination?',
    solution: 'Aditya tracks contracts, sends timeline updates, and manages day-of vendor check-ins.',
    keyPoints: [
      'Tracks contracts & payments',
      'Sends timeline updates',
      'Day-of check-ins',
    ],
    pricing: 39,
    badge: 'COMING SOON',
  ...
  },
  {
    ...
    problem: 'Want to ensure every special moment and person is captured?',
    solution: 'Nisha creates shot lists, coordinates guest photo sharing, and organizes family photo groupings.',
    keyPoints: [
      'Creates shot lists',
      'Collects guest photos',
      'Organizes family groups',
    ],
    pricing: 29,
    badge: 'COMING SOON',
    ctaType: 'waitlist' as const,
  },
  {
    ...
    problem: 'Worried about timing delays and keeping everyone on schedule?',
    solution: 'Vikram creates detailed timelines, alerts the wedding party, and adjusts for delays in real-time.',
    keyPoints: [
      'Builds detailed timelines',
      'Alerts wedding party',
      'Adjusts for delays',
    ],
    pricing: 39,
    badge: 'COMING SOON',
  ...
  },
  {
    ...
    problem: 'Guests asking "What should I wear?" or struggling with cultural attire?',
    solution: 'Kavya suggests outfit options per event, coordinates colors, and explains traditional attire.',
    keyPoints: [
      'Suggests outfit options',
      'Coordinates color schemes',
      'Explains cultural attire',
    ],
    pricing: 29,
    badge: 'COMING SOON',
    ctaType: 'waitlist' as const,
  },
  {
    ...
    problem: 'Losing track of expenses and going over budget?',
    solution: 'Rahul tracks expenses, suggests cost-saving alternatives, and provides spending reports.',
    keyPoints: [
      'Tracks all expenses',
  ...
  },
  {
    ...
    problem: 'Non-Indian guests confused about rituals and customs?',
    solution: 'Lakshmi explains traditions, provides etiquette guides, and helps everyone participate respectfully.',
    keyPoints: [
      'Explains rituals & customs',
      'Provides etiquette guides',
  ...
  },
  {
    ...
    problem: 'Managing registry contributions and group gifts is complicated?',
    solution: 'Sanjay guides guests through registry, coordinates group gifts, and tracks contributions.',
    keyPoints: [
      'Guides guests through registry',
      'Coordinates group gifts',
        ...
        <Container maxWidth="lg" sx={{ pt: { xs: 16, md: 24 }, pb: 10 }}>
          <motion.div initial="hidden" animate="visible" variants={fadeIn}>
            <Stack spacing={4} sx={{ alignItems: 'center', textAlign: 'center' }}>
              ...
              >
                Start free with everything you need. Add smart AI agents only when 
                you need extra help—from travel coordination to guest communication.
