...
const DiamondDecoration = () => (
  <Box
    sx={{
      width: { xs: 50, sm: 65, lg: 75, xl: 85 },
      height: { xs: 12, sm: 16, lg: 18, xl: 20 },
      display: 'flex',
      alignItems: 'center',
  ...
  >
    <svg width="85" height="20" viewBox="0 0 65 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const MenuItem = ({
  ...
  >
    <Box
      sx={{
        py: { xs: 1.5, sm: 2, lg: 2.5, xl: 3 },
        px: { xs: 3, sm: 4, lg: 5, xl: 6 },
        borderRadius: 2,
    ...
    >
      <Typography
        ...
        sx={{
          fontFamily: 'Outfit',
          fontWeight: 400,
          fontSize: { xs: 16, sm: 18, md: 20, lg: 24, xl: 28 },
          lineHeight: 1.5,
          letterSpacing: '5.56%',
    ...
    >
      ...
      >
        <Container 
          maxWidth={false}
          sx={{
            maxWidth: { xs: 361, md: 600, lg: 700, xl: 800 },
            px: { xs: 2, md: 3 },
          }}
        >
          <Stack direction="row" alignItems="center" justifyContent="space-between">
            <IconButton
              ...
              sx={{
                ...
                width: { xs: 40, lg: 48, xl: 56 },
                height: { xs: 40, lg: 48, xl: 56 },
                '&:hover': {
                  backgroundColor: 'rgba(255, 255, 255, 0.2)',
                },
                '& .MuiSvgIcon-root': {
                  fontSize: { xs: '1.5rem', lg: '1.75rem', xl: '2rem' },
                },
              }}
            >
              <ArrowBack />
            ...
            {shouldShowWhatsApp && (
              <IconButton
                ...
                sx={{
                  width: { xs: 32, lg: 40, xl: 48 },
                  height: { xs: 32, lg: 40, xl: 48 },
                  backgroundColor: '#000',
                  color: '#fff',
                  '&:hover': {
                    backgroundColor: '#333',
      ...
      >
        <Container
          maxWidth={false}
          sx={{
            maxWidth: { xs: '100%', md: 600, lg: 700, xl: 800 },
            px: { xs: 2, md: 3 },
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
        ...
        >
          ...
          >
            <Stack spacing={{ xs: 1.5, sm: 2, md: 3 }} alignItems="center" sx={{ justifyContent: 'center' }}>
              {/* Menu Items */}
              <Stack
                spacing={{ xs: 1.5, sm: 2, lg: 2.5, xl: 3 }}
                sx={{
                  width: '100%',
                  maxWidth: { xs: '90%', sm: 361, md: 500, lg: 600, xl: 700 },
                  alignItems: 'center',
                }}
              >
                <MenuItem 
