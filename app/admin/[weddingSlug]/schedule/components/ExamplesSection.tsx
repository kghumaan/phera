...
export default function ExamplesSection({ onDismiss }: ExamplesSectionProps) {
  return (
    <Box sx={{ bgcolor: '#EEF4F4', borderRadius: '16px', p: 3, position: 'relative' }}>
      <IconButton
        onClick={onDismiss}
        size="small"
        sx={{ position: 'absolute', top: 12, right: 12, color: '#1a1a1a' }}
      >
        <Close fontSize="small" />
      </IconButton>

      <Typography sx={{ fontWeight: 600, color: '#1a1a1a', fontSize: '1rem', mb: 2.5 }}>
        Examples
      </Typography>
      ...
      <Stack spacing={2}>
        ...
        <Box sx={{
          ...
          <Typography sx={{ fontWeight: 600, color: '#1a1a1a', fontSize: '1.1rem', mb: 1 }}>
            Minor Events{' '}
            <Typography component="span" sx={{ fontWeight: 400, color: '#858585', fontSize: '1.1rem' }}>
        ...
        <Box sx={{
          ...
          <Box sx={{ px: 2, py: 2.5, flex: 1 }}>
            ...
            <Typography sx={{ color: '#858585', fontSize: '1rem', lineHeight: 1.5, mb: 1.5 }}>
