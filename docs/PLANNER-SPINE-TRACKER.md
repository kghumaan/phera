...
> Source: founder requirements notes, 2026-07-02. This is the working tracker for the full planner-spine build.
...
## G. Evals (added 2026-07-02 per founder request)
...
| F3 | **TTS (voice onboarding) — BACKLOG, not an active feature.** Founder decision, 2026-07-02: keep it *working* (green tests, no rot) but don't invest in it as a feature right now. | BACKLOG | Includes fixing the F2 test so the suite stays green. |
